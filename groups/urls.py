...
urlpatterns = [
    ...
    path('update-user-group/<str:slug>/<str:groupslug>', update_user_group, name='update-group'),
    path('update-group-details/<str:groupslug>', update_group, name='update-group-details')
]